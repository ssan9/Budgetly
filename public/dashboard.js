Ext.Array.forEach(data.items, function (item) {
    ...
    var deleteIconLink = 'https://dev.sencha.com/ext/5.0.1/examples/kitchensink/resources/images/icons/fam/delete.gif',
        kitchenSinkForkLink = 'https://dev.sencha.com/ext/5.0.0/examples/kitchensink/#cell-editing',
